  ...
  plop.setGenerator("component", {
    ...
    actions: (data) => {
      ...
      return [
        {
          type: "add",
          path: `${componentDir}${componentName}/${componentName}.sc.tsx`,
          templateFile: "./component.sc.tsx.hbs",
        },
        {
          type: "add",
          path: `${componentDir}${componentName}/${componentName}.cc.tsx`,
          templateFile: "./component.cc.tsx.hbs",
        },
        {
          type: "modify",
          path: viteConfigPath,
          ...
          transform: (fileContent) => {
            ...
            const newScEntry = `src/components/wrapped/${componentName}/${componentName}.sc.tsx`;
            const newCcEntry = `src/components/wrapped/${componentName}/${componentName}.cc.tsx`;

            entries.push(newScEntry);
            entries.push(newCcEntry);
            entries.sort();
        ...
        },
        {
          ...
          transform: (fileContent) => {
            ...
            const newExport = {
              "types": `./dist/types/components/wrapped/${componentName}/${componentName}.cc.d.ts`,
              "react-server": `./dist/packages/react/src/components/wrapped/${componentName}/${componentName}.sc.js`,
              "import": `./dist/packages/react/src/components/wrapped/${componentName}/${componentName}.cc.js`,
              "require": `./dist/packages/react/src/components/wrapped/${componentName}/${componentName}.cc.cjs`,
              "default": `./dist/packages/react/src/components/wrapped/${componentName}/${componentName}.cc.js`,
            };
